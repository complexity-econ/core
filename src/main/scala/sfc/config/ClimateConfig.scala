...
/** Energy costs and climate policy: EU ETS carbon pricing, green capital investment, and decarbonization.
  ...
  * Fit for 55), and green capital investment pathway: firms allocate a budget share to green capital with separate K/L
  * ratios, achieving energy cost discounts up to 30% as green capital stock grows. Green capital has lower depreciation
  * than conventional capital.
  *
  * @param energyCostShares
  *   per-sector energy cost as fraction of revenue (6 sectors, Eurostat/GUS 2023)
  * @param carbonIntensity
  *   per-sector carbon intensity in tCO2/PLN of revenue (6 sectors, KOBiZE 2024)
  * @param etsBasePrice
  ...
  *   fraction of firm investment budget allocated to green capital (default 20%)
