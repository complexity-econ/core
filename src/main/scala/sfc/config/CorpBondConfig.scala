...
/** Corporate bond market (Catalyst): issuance, buyer composition, and default recovery.
  ...
  * employees), buyer composition split across banks, PPK funds, and other investors. Calibrated to KNF 2024 (Catalyst +
  * non-public), with BBB Polish corporate spread (RRRF 2024). Affects SFC Identity 12.
  *
