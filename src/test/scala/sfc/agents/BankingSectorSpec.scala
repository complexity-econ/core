...
class BankingSectorSpec extends AnyFlatSpec with Matchers:
  ...
  "BankingSector.lendingRate" should "return high spread for failed bank" in {
    val bank = IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(1e5), PLN(0), PLN(0), PLN(0), PLN(0), failed = true, 30, 0)
    val rate = BankingSector.lendingRate(bank, configs(0), 0.05)
    rate shouldBe (0.05 + 0.50) +- 0.001
  }

  it should "increase with NPL ratio" in {
    val bankLowNpl = IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(1e4), PLN(0), PLN(0), PLN(0), false, 0, 0)
    val bankHighNpl = IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(2e5), PLN(0), PLN(0), PLN(0), false, 0, 0)
  ...
  it should "include bank-specific spread" in {
    val bank = IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0)
  ...
  it should "reject when projected CAR too low" in {
    ...
    val bank = IndividualBankState(BankId(0), PLN(1e6), PLN(100000.0), PLN(8000.0), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0)
  ...
  "BankingSector.interbankRate" should "return deposit rate when NPL is zero" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(1e6), PLN(1e6), PLN(2e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0)
    )
  ...
  it should "approach lombard rate when NPL is high" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(1e5), PLN(0), PLN(0), PLN(0), false, 0, 0),  // 10% NPL
      IndividualBankState(BankId(1), PLN(1e6), PLN(1e6), PLN(2e5), PLN(1e5), PLN(0), PLN(0), PLN(0), false, 0, 0)
    )
    val rate = BankingSector.interbankRate(banks, 0.05)
  ...
  "BankingSector.clearInterbank" should "produce interbankNet that sums to zero" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(3e5), PLN(2e5), PLN(0), PLN(1e5), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(5e5), PLN(8e5), PLN(1e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(2), PLN(8e5), PLN(2e5), PLN(1.5e5), PLN(0), PLN(5e4), PLN(0), PLN(0), false, 0, 0)
    )
  ...
  it should "set failed banks' interbankNet to zero" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(3e5), PLN(2e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(5e5), PLN(8e5), PLN(1e5), PLN(0), PLN(0), PLN(0), PLN(0), failed = true, 30, 3)
    )
  ...
  "BankingSector.checkFailures" should "not trigger when disabled" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(1000.0), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 5)  // Very low CAR
    )
  ...
  it should "trigger after 3 consecutive months of low CAR" in {
    val bank = IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(1000.0), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 2)
  ...
  it should "reset consecutive counter when CAR recovers" in {
    val bank = IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 2)  // CAR = 0.20 > MinCar
    val (result, anyFailed) = BankingSector.checkFailures(Vector(bank), 30, enabled = true)
    anyFailed shouldBe false
  ...
  "BankingSector.resolveFailures" should "transfer deposits to healthiest bank" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(500000.0), PLN(100000.0), PLN(50000.0), PLN(0), PLN(10000.0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(300000.0), PLN(80000.0), PLN(0.0), PLN(0), PLN(5000.0), PLN(0), PLN(0), failed = true, 30, 3)
    )
  ...
  "BankingSector.allocateBonds" should "distribute proportional to deposits" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(600000.0), PLN(0), PLN(1e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(400000.0), PLN(0), PLN(1e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0)
    )
  ...
  it should "handle negative deficit (surplus)" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(500000.0), PLN(0), PLN(1e5), PLN(0), PLN(8000.0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(500000.0), PLN(0), PLN(1e5), PLN(0), PLN(2000.0), PLN(0), PLN(0), false, 0, 0)
    )
  ...
  it should "have per-bank deltas summing to exactly deficit (residual-based)" in {
    ...
    val banks = (0 until 7).map(i =>
      IndividualBankState(BankId(i), PLN(1e6 / 7.0 * (i + 1)), PLN(0), PLN(1e5), PLN(0), PLN(1000.0 * (i + 1)), PLN(0), PLN(0), false, 0, 0)
    ).toVector
  ...
  "BankingSector.allocateQePurchases" should "sell proportional to bond holdings" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(0), PLN(1e5), PLN(0), PLN(6000.0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(1e6), PLN(0), PLN(1e5), PLN(0), PLN(4000.0), PLN(0), PLN(0), false, 0, 0)
    )
  ...
  it should "not change banks when qeTotal is zero" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(0), PLN(1e5), PLN(0), PLN(5000.0), PLN(0), PLN(0), false, 0, 0)
    )
  ...
  "BankingSector.reassignBankId" should "keep valid bank unchanged" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(1e6), PLN(1e6), PLN(1e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0)
    )
  ...
  it should "route to healthiest bank when current bank failed" in {
    val banks = Vector(
      IndividualBankState(BankId(0), PLN(1e6), PLN(1e6), PLN(2e5), PLN(0), PLN(0), PLN(0), PLN(0), false, 0, 0),
      IndividualBankState(BankId(1), PLN(1e6), PLN(1e6), PLN(1e5), PLN(0), PLN(0), PLN(0), PLN(0), failed = true, 30, 3)
    )
